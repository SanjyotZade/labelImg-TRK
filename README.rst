...
Tracking has been recently added to LabelImg to fasten the data annotation process.
...
5. Currently the labelImg supports 6-7 different tracking algorithms. Some deep learning based tracking algorithms are coming soon.
...
- If tracker has predicted bounding boxes then log will appear in the title of the "labelImg" app, notifying some information.
