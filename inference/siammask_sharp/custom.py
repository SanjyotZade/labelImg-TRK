...
dir_path_ = os.path.sep.join(dir_path.split("/")[:-1])
sys.path.insert(1, os.path.join(dir_path_, "utils"))
sys.path.insert(1, os.path.join(dir_path_, "models"))


from siammask_sharp import SiamMask
